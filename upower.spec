...
Version  : 0.99.6
Release  : 13
URL      : https://upower.freedesktop.org/releases/upower-0.99.6.tar.xz
Source0  : https://upower.freedesktop.org/releases/upower-0.99.6.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1505147364
