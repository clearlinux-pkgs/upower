...
Version  : 0.99.16
Release  : 28
URL      : https://gitlab.freedesktop.org/upower/upower/-/archive/v0.99.16/upower-v0.99.16.tar.gz
Source0  : https://gitlab.freedesktop.org/upower/upower/-/archive/v0.99.16/upower-v0.99.16.tar.gz
...
%prep
%setup -q -n upower-v0.99.16
cd %{_builddir}/upower-v0.99.16
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645809561
...
cp %{_builddir}/upower-v0.99.16/COPYING %{buildroot}/usr/share/package-licenses/upower/9e010b11705daec7ebf9c01a32d6f09ee444968d
