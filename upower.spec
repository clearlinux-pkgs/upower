...
Source0  : https://gitlab.freedesktop.org/upower/upower/-/archive/UPOWER_0_99_13/upower-UPOWER_0_99_13.tar.gz
...
%prep
%setup -q -n upower-UPOWER_0_99_13
cd %{_builddir}/upower-UPOWER_0_99_13
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629383465
...
cp %{_builddir}/upower-UPOWER_0_99_13/COPYING %{buildroot}/usr/share/package-licenses/upower/9e010b11705daec7ebf9c01a32d6f09ee444968d
%make_install
%find_lang upower
