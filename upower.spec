...
Source0  : https://gitlab.freedesktop.org/upower/upower/-/archive/v1.90.0/upower-v1.90.0.tar.gz
...
%prep
%setup -q -n upower-v1.90.0
cd %{_builddir}/upower-v1.90.0
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672203941
