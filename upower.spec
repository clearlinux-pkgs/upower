...
Source0  : https://gitlab.freedesktop.org/upower/upower/-/archive/v1.90.2/upower-v1.90.2.tar.gz
...
%prep
%setup -q -n upower-v1.90.2
cd %{_builddir}/upower-v1.90.2
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a upower-v1.90.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688665056
