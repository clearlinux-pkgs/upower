...
Version  : 0.99.17
Release  : 29
URL      : https://gitlab.freedesktop.org/upower/upower/-/archive/v0.99.17/upower-v0.99.17.tar.gz
Source0  : https://gitlab.freedesktop.org/upower/upower/-/archive/v0.99.17/upower-v0.99.17.tar.gz
...
%prep
%setup -q -n upower-v0.99.17
cd %{_builddir}/upower-v0.99.17
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646870077
...
cp %{_builddir}/upower-v0.99.17/COPYING %{buildroot}/usr/share/package-licenses/upower/9e010b11705daec7ebf9c01a32d6f09ee444968d
