...
Source0  : https://gitlab.freedesktop.org/upower/upower/-/archive/v1.90.4/upower-v1.90.4.tar.gz
...
%prep
%setup -q -n upower-v1.90.4
cd %{_builddir}/upower-v1.90.4
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a upower-v1.90.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743195946
