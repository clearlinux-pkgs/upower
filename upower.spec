...
Source0  : https://gitlab.freedesktop.org/upower/upower/-/archive/UPOWER_0_99_12/upower-UPOWER_0_99_12.tar.gz
...
%prep
%setup -q -n upower-UPOWER_0_99_12
cd %{_builddir}/upower-UPOWER_0_99_12
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624043744
...
cp %{_builddir}/upower-UPOWER_0_99_12/COPYING %{buildroot}/usr/share/package-licenses/upower/9e010b11705daec7ebf9c01a32d6f09ee444968d
%make_install
%find_lang upower
