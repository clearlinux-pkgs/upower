...
Version  : 0.99.20
Release  : 31
URL      : https://gitlab.freedesktop.org/upower/upower/-/archive/v0.99.20/upower-v0.99.20.tar.gz
Source0  : https://gitlab.freedesktop.org/upower/upower/-/archive/v0.99.20/upower-v0.99.20.tar.gz
...
%prep
%setup -q -n upower-v0.99.20
cd %{_builddir}/upower-v0.99.20
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657817466
...
cp %{_builddir}/upower-v0.99.20/COPYING %{buildroot}/usr/share/package-licenses/upower/9e010b11705daec7ebf9c01a32d6f09ee444968d
